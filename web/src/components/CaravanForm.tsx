  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-100 shadow-md p-4 md:p-5">
      ...
      <div className="grid gap-2">
        ...
        />
        <button
          className="bg-[#0F766E] text-white px-3 py-2 rounded-2xl text-sm font-medium hover:bg-[#115e57] disabled:opacity-60 disabled:cursor-not-allowed transition-colors shadow-md"
